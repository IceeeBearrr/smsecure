...
class SetNewPasswordLogin extends StatefulWidget {
  final String phone;
  const SetNewPasswordLogin({super.key, required this.phone});

  @override
  _SetNewPasswordLoginState createState() => _SetNewPasswordLoginState();
}

class _SetNewPasswordLoginState extends State<SetNewPasswordLogin> {
