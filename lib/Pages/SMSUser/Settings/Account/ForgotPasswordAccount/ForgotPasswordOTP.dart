...
import 'package:smsecure/Pages/SMSUser/Settings/Account/ForgotPasswordAccount/SetNewPassword.dart';
...
class ForgotPasswordOTP extends StatefulWidget {
  ...
  const ForgotPasswordOTP({super.key, required this.phone});
          ...
          TextButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => SetNewPassword(phone: widget.phone),
                ),
              );
            },
            child: const Text('OK'),
